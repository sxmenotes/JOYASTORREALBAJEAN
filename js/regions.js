...
function initRegionCitySelects(regionSelectId, citySelectId) {
    ...
    regionSelect.addEventListener('change', (e) => {
        ...
        const cities = chileData[selectedRegion] || [];
...
document.addEventListener('DOMContentLoaded', () => {
    // Initialize for contact form if elements exist
    initRegionCitySelects('contact-region', 'contact-city');
    
    // Initialize for quote form if elements exist
    initRegionCitySelects('wa-region', 'wa-city');
    
    // Initialize for workshop form if elements exist
    initRegionCitySelects('ws-region', 'ws-city');
});
